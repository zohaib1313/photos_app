                ...
                children: [
                  ...
                  CircleNavBar(
                    activeIcons: [
                      ...
                      Icon(Icons.settings, color: context.theme.primaryColor),
                    ],
                    inactiveIcons: [
                      Icon(Icons.home, color: context.theme.hintColor),
                      Icon(Icons.person, color: context.theme.hintColor),
                      Icon(Icons.account_box, color: context.theme.hintColor),
                      Icon(Icons.settings, color: context.theme.hintColor),
                    ],
                    ...
                    shadowColor: context.theme.primaryColorDark,
                    elevation: 10,
                  ),
                ],
              ),
